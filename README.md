# xray_rat_hindlimb
[You can check out (and cite!) our paper here](https://doi.org/10.1242/jeb.244540)
...
Our models should be able to be applied to your x-ray videos of rat locomotion. We believe this based on the generalizability of previous optical-video models that have demonstrated an ability to adapt to new videos after being briefly retrained (see horse example in Mathis, et al. 2021). 
